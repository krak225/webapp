	...
	<section class="panel panel-default"> 
		...
		<div class="row m-l-none m-r-none bg-light lter"> 
			...
			<div class="col-sm-8 col-md-4 padder-v b-r b-light"> 
				...
				<a class="clear" href="<?php echo e(route('evenements_a_facturer')); ?>"> 
					<span class="h3 block m-t-xs">
					<strong id="bugs"><?php echo e(number_format($evenements_a_facturer, 0, '', ' ')); ?></strong>
					</span> 
			...
			<div class="col-sm-8 col-md-4 padder-v b-r b-light"> 
				...
				<a class="clear" href="<?php echo e(route('evenements_factures')); ?>"> 
					<span class="h3 block m-t-xs">
					<strong id="bugs"><?php echo e(number_format($evenements_factures, 0, '', ' ')); ?></strong>
					</span> 
