...
<div class="m-b-md"> 
	<h3 class="m-b-none">Mon compte utilisateur</h3> 
</div>
				...
				<div class="wrapper">
					<div class="panel wrapper panel-info">
						<div class="text-center bg-info">
							...
							<?php else: ?>
							<img id="myphoto" class="col-md-12 rounded img-responsive" src="<?php echo e(asset('images/avatar.jpg')); ?>"/>
							<?php endif; ?>
						</div>
						...
						<div class="row">
							...
							<form method="post" action="<?php echo e(route('UpdatePhoto')); ?>" enctype="multipart/form-data" class="dropzone" id="dropzone">
								<?php echo csrf_field(); ?>
					...
					<div class="panel wrapper panel-info">
						<div class="text-center bg-info">Ma signature</div>
						<div class="text-center">
							<?php if(!empty($user->signature)): ?>
							<img class="" src="data:image/jpeg;base64,<?php echo e(Stdfn::KHLOE_DECRYPT($user->signature)); ?>" style="width:120px;"/>
							<?php endif; ?>
						</div>
					</div> 
			...
			<div class="col-md-8 bordered">
				...
				<div class="list-group radius"> 
					<span class="list-group-item"> 
						<span class="badge bg-light"><?php echo e($user->nom . ' ' . $user->prenoms); ?></span> 
					...
					<span class="list-group-item"> 
						<span class="badge bg-light">Profil <?php echo e($user->profil_id . ' : ' . $user->profil_libelle); ?></span> 
						<i class="fa fa- icon-muted"></i> Profil 
					</span> 
					<span class="list-group-item"> 
						<span class="badge bg-light"><?php echo e($user->adresse_email); ?></span> 
					...
					<span class="list-group-item"> 
						<span class="badge bg-light"><?php echo e($user->service_nom); ?></span> 
						<i class="fa fa- icon-muted"></i> Département/Service 
					</span>
					<span class="list-group-item"> 
						<span class="badge bg-light"><?php echo e($user->direction_nom); ?></span> 
						<i class="fa fa- icon-muted"></i> Direction 
					</span>
