...
<ul class="breadcrumb no-border no-radius b-b b-light pull-in"> 
	...
	<li class="active">Presence du participant</li> 
</ul> 
...
<div class="panel panel-default"> 
	...
	<div class="step-content clearfix"> 
		<form method="post" action="/participants" enctype="multipart/form-data" class="form-horizontal">
	...
	<div class="table-responsive"> 
		<table id="table_courriers" class="table table-striped m-b-none datatable "> 
			...
			<?php $__currentLoopData = $participant; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $participant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<tr>
					<td><a href="<?php echo e(route('show-participant', $participant->participant_id)); ?>"><i class="fa fa-cogs text-info" title="Afficher les détails"></i></a></td> 
					<td><span class="btnModifierpresence" data-presence_id="<?php echo e($participant->participant_id); ?>" style="cursor: pointer;"><i class="fa fa-edit text-warning" title="Modifier"></i></span></td> 
