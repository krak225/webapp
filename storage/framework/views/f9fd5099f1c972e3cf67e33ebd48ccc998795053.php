				...
				<section class="panel panel-default"> 
					...
					<div class="list-group no-radius alt"> 
						...
						<span class="list-group-item"> 
							<span class="badge bg-light"><?php echo e($participan->participan_nom); ?></span> 
							<i class="fa fa- icon-muted"></i> Nom du participant 
						</span>
						<span class="list-group-item"> 
							<span class="badge bg-light"><?php echo e($participan->participan_contact); ?></span> 
							<i class="fa fa- icon-muted"></i> Contact du participant 
						</span>
						<span class="list-group-item"> 
							<span class="badge bg-light"><?php echo e($participan->participan_email); ?></span> 
							<i class="fa fa- icon-muted"></i> Email du participant 
						</span>	
						<span class="list-group-item"> 
							<span class="badge bg-light"><?php echo e($participan->participan_fonction); ?></span> 
							<i class="fa fa- icon-muted"></i> Fonction du participant 
						</span>
						<span class="list-group-item"> 
							<span class="badge bg-light"><?php echo e($participan->participan_society); ?></span> 
							<i class="fa fa- icon-muted"></i> Société du participant 
						</span>				
