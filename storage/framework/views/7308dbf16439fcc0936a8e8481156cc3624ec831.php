				...
				<section class="panel panel-default">
					<div class="list-group no-radius alt"> 
						...
						<span class="list-group-item"> 
							...
							<i class="fa fa- icon-muted"></i> Montant à payé
						</span>		
						<span class="list-group-item"> 
						...
						<span class="list-group-item"> 
							<span class="badge" style="background:none;"><?php if($evenement->evenement_statut_facturation == "NON FACTURE"): ?><span id="btnChangerStatutFacturationEvenement" data-evenement_id="<?php echo e($evenement->evenement_id); ?>" class="btn btn-sm btn-default" style="display: inline-block;padding:0px 10px;">Changer le statut</span> <?php endif; ?> <span class="label label-<?php echo e(strtolower(str_replace(' ', '',$evenement->evenement_statut_facturation))); ?>"><?php echo e($evenement->evenement_statut_facturation); ?></span></span> 
							<i class="fa fa- icon-muted"></i> Statut facturation 
						</span>
						<span class="list-group-item"> 
							<span class="badge" style="background:none;"><?php if($evenement->evenement_statut_paiement == "NON PAYE"): ?><span id="btnChangerStatutPaiementEvenement" data-evenement_id="<?php echo e($evenement->evenement_id); ?>" class="btn btn-sm btn-default" style="display: inline-block;padding:0px 10px;">Changer le statut</span> <?php endif; ?> <span class="label label-<?php echo e(strtolower(str_replace(' ', '',$evenement->evenement_statut_paiement))); ?>"><?php echo e($evenement->evenement_statut_paiement); ?></span></span> 
							<i class="fa fa- icon-muted"></i> Statut paiement 
						</span>
						<span class="list-group-item"> 
							Observations
							<div class="badged bg-light" style="display:block;"><?php echo e($evenement->evenement_observations); ?></div>
						</span>
					</div>
